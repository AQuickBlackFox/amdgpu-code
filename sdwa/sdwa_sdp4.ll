...
define i32 @sdwa(i32 %in1, i32 %in2, i32 %in3) {
  %val1 = tail call i32 asm "v_mul_u32_u24_sdwa $0, sext($1), sext($2) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:BYTE_0","=v,v,v"(i32 %in1, i32 %in2)
  %ret1 = add i32 %val1, %in3
  %val2 = tail call i32 asm "v_mul_u32_u24_sdwa $0, sext($1), sext($2) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:BYTE_1","=v,v,v"(i32 %in1, i32 %in2)
  %ret2 = add i32 %ret1, %val2
  %val3 = tail call i32 asm "v_mul_u32_u24_sdwa $0, sext($1), sext($2) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_2 src1_sel:BYTE_2","=v,v,v"(i32 %in1, i32 %in2)
  %ret3 = add i32 %val3, %ret2
  %val4 = tail call i32 asm "v_mul_u32_u24_sdwa $0, sext($1), sext($2) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_3 src1_sel:BYTE_3","=v,v,v"(i32 %in1, i32 %in2)

...
define i32 @sdwa(i32 %in1, i32 %in2, i32 %in3) {
  %val1 = tail call i32 asm "v_add_f16_sdwa $0, $1, $2 dst_sel:WORD_0 dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:WORD_0","=v,v,v"(i32 %in1, i32 %in2)
  call void asm "v_add_f16_sdwa $0, $1, $2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1","v,v,v"(i32 %val1, i32 %in1, i32 %in2)
  ret i32 %val1
}

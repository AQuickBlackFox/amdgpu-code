...
/**
Dependent Thread Scheduling
*/
__global__ void DTS(T *A, T *B, T *C, T *D) {
...
int main() {
  ...
  hipLaunchKernelGGL(DTS, dim3(1,1,1), dim3(len,1,1), 0, 0, Ad, Bd, Cd, Dd);

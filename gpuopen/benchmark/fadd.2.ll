...
define amdgpu_kernel void @DoFAdd(float* nocapture readonly %in1d, float* nocapture %outd) local_unnamed_addr #5 {
...
; <label>:5:                                      ; preds = %5, %0
  ...
  %add = fadd float %2, %out.015
  %add.1 = fadd float %2, %add
  %add.2 = fadd float %2, %add.1
  %add.3 = fadd float %2, %add.2
  %add.4 = fadd float %2, %add.3
  %add.5 = fadd float %2, %add.4
  %add.6 = fadd float %2, %add.5
  %add.7 = fadd float %2, %add.6
  %add.8 = fadd float %2, %add.7
  %add.9 = fadd float %2, %add.8
  %add.10 = fadd float %2, %add.9
  %add.11 = fadd float %2, %add.10
  %add.12 = fadd float %2, %add.11
  %add.13 = fadd float %2, %add.12
  %add.14 = fadd float %2, %add.13
  %add.15 = fadd float %2, %add.14
  %add.16 = fadd float %2, %add.15
  %add.17 = fadd float %2, %add.16
  %add.18 = fadd float %2, %add.17
  %add.19 = fadd float %2, %add.18
  %add.20 = fadd float %2, %add.19
  %add.21 = fadd float %2, %add.20
  %add.22 = fadd float %2, %add.21
  %add.23 = fadd float %2, %add.22
  %add.24 = fadd float %2, %add.23
  %add.25 = fadd float %2, %add.24
  %add.26 = fadd float %2, %add.25
  %add.27 = fadd float %2, %add.26
  %add.28 = fadd float %2, %add.27
  %add.29 = fadd float %2, %add.28
  %add.30 = fadd float %2, %add.29
  %add.31 = fadd float %2, %add.30
  %add.32 = fadd float %2, %add.31
  %add.33 = fadd float %2, %add.32
  %add.34 = fadd float %2, %add.33
  %add.35 = fadd float %2, %add.34
  %add.36 = fadd float %2, %add.35
  %add.37 = fadd float %2, %add.36
  %add.38 = fadd float %2, %add.37
  %add.39 = fadd float %2, %add.38
  %add.40 = fadd float %2, %add.39
  %add.41 = fadd float %2, %add.40
  %add.42 = fadd float %2, %add.41
  %add.43 = fadd float %2, %add.42
  %add.44 = fadd float %2, %add.43
  %add.45 = fadd float %2, %add.44
  %add.46 = fadd float %2, %add.45
  %add.47 = fadd float %2, %add.46
  %add.48 = fadd float %2, %add.47
  %add.49 = fadd float %2, %add.48
  %add.50 = fadd float %2, %add.49
  %add.51 = fadd float %2, %add.50
  %add.52 = fadd float %2, %add.51
  %add.53 = fadd float %2, %add.52
  %add.54 = fadd float %2, %add.53
  %add.55 = fadd float %2, %add.54
  %add.56 = fadd float %2, %add.55
  %add.57 = fadd float %2, %add.56
  %add.58 = fadd float %2, %add.57
  %add.59 = fadd float %2, %add.58
  %add.60 = fadd float %2, %add.59
  %add.61 = fadd float %2, %add.60
  %add.62 = fadd float %2, %add.61
  %add.63 = fadd float %2, %add.62

...
define void @_Z15__rocm_hadd_low7__half2S_(%struct.__half2* noalias nocapture sret %agg.result, %struct.__half2* byval nocapture readonly align 4 %a, %struct.__half2* byval nocapture readonly align 4 %b) local_unnamed_addr #5 {
  ...
  %add = fadd half %1, %2
  %arrayidx4 = bitcast %struct.__half2* %agg.result to half*
  store half %add, half* %arrayidx4, align 4, !tbaa !7
  ret void
}

; Function Attrs: alwaysinline norecurse nounwind
define void @_Z16__rocm_hadd_high7__half2S_(%struct.__half2* noalias nocapture sret %agg.result, %struct.__half2* byval nocapture readonly align 4 %a, %struct.__half2* byval nocapture readonly align 4 %b) local_unnamed_addr #5 {
  ...
  %add = fadd half %2, %4
  %arrayidx8 = bitcast %struct.__half2* %agg.result to half*
  store half %add, half* %arrayidx8, align 4, !tbaa !7
  %x9 = getelementptr inbounds %struct.__half2, %struct.__half2* %agg.result, i32 0, i32 0, i32 0
  %5 = load i32, i32* %x9, align 4, !tbaa !9
  %shl = shl i32 %5, 16
  store i32 %shl, i32* %x9, align 4, !tbaa !9
  ret void
}
...
;  %add.i.1 = fadd half %2, %add.i
;  %add.i35.1 = fadd half %3, %add.i35
;  %add.i.2 = fadd half %2, %add.i.1
;  %add.i35.2 = fadd half %3, %add.i35.1
;  %add.i.3 = fadd half %2, %add.i.2
;  %add.i35.3 = fadd half %3, %add.i35.2
;  %add.i.4 = fadd half %2, %add.i.3
;  %add.i35.4 = fadd half %3, %add.i35.3
;  %add.i.5 = fadd half %2, %add.i.4
;  %add.i35.5 = fadd half %3, %add.i35.4
;  %add.i.6 = fadd half %2, %add.i.5
;  %add.i35.6 = fadd half %3, %add.i35.5
;  %add.i.7 = fadd half %2, %add.i.6
;  %8 = bitcast half %add.i.7 to i16
   %8 = bitcast half %add.i to i16
  %ref.tmp.sroa.0.0.insert.ext.7 = zext i16 %8 to i32
;  %add.i35.7 = fadd half %3, %add.i35.6
;  %9 = bitcast half %add.i35.7 to i16

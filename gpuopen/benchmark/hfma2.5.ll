...
define i32 @__rocm_hfma2(i32 %a, i32 %b, i32 %c) {
  %1 = tail call i32 asm sideeffect "v_mov_b32 $0, $1","=v,v"(i32 %c)
  tail call void asm sideeffect "v_mac_f16 $0, $1, $2","v,v,v"(i32 %1, i32 %a, i32 %b)
  tail call void asm sideeffect "v_mac_f16_sdwa $0, $1, $2 dst_sel:WORD_1 dst_unused:UNUSED_PRESERVE src0_sel:WORD_1 src1_sel:WORD_1","v,v,v"(i32 %1, i32 %a, i32 %b)
  ret i32 %1
}
...
;  %call5.7 = tail call i32 @__rocm_hfma_low(i32 %2, i32 %b0.025, i32 %4) #13
  %call6.7 = tail call i32 @__rocm_hfma2(i32 %2, i32 %b0.025, i32 %4) #13

...
define i32 @__rocm_hfma_low(i32 %a, i32 %b, i32 %c) {
  %1 = bitcast i32 %a to <2 x half>
  %2 = bitcast i32 %b to <2 x half>
  %3 = bitcast i32 %c to <2 x half>
  %a.0 = extractelement <2 x half> %1, i32 0
  %a.1 = extractelement <2 x half> %1, i32 1

  %b.0 = extractelement <2 x half> %2, i32 0
  %b.1 = extractelement <2 x half> %2, i32 1

  %c.0 = extractelement <2 x half> %3, i32 0
  %c.1 = extractelement <2 x half> %3, i32 1

  %mul.0 = fmul half %a.0, %b.0
  %d.0 = fadd half %mul.0, %c.0

  %mul.1 = fmul half %a.1, %b.1
  %d.1 = fadd half %mul.1, %c.1

  %d0 = insertelement <2 x half> undef, half %d.0, i32 0
  %d1 = insertelement <2 x half> %d0, half %d.1, i32 1

  %d3 = bitcast <2 x half> %d1 to i32
...
; <label>:5:                                      ; preds = %6
  store i32 %call5.7, i32* %arrayidx4, align 4, !tbaa !7
  ret void

; <label>:6:                                      ; preds = %6, %0
  %i.026 = phi i32 [ 0, %0 ], [ %inc.7, %6 ]
  %b0.025 = phi i32 [ %3, %0 ], [ %call5.7, %6 ]

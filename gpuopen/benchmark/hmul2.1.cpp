...
__global__ void DoMul2PK(hipLaunchParm lp, __half2 *a, __half2 *b) {
...
int main() {
  ...
  hipLaunchKernel(DoHMulPK, dim3(WG,1,1), dim3(WI,1,1), 0, 0, ad, bd);
  ...
  std::cout<<et<<"s for "<<Mops<<" HMul2PK"<<std::endl;

...
define half @__rocm_hfma_half_cvt_float(half %a, half %b, half %c) {
  ...
  %7 = fmul float %4, %5
  %8 = fadd float %7, %6
  %9 = call i16 @llvm.convert.to.fp16.f32(float %8)
...
; <label>:7:                                      ; preds = %7, %0
  ...
  %add.i = call half @__rocm_hfma_half_cvt_float(half %2, half %8, half %3)
;  %mul.i = fmul half %2, %8
...
;  %mul.i47 = fmul half %4, %9
;  %add.i48 = fadd half %5, %mul.i47
  %add.i48 = call half @__rocm_hfma_half_cvt_float(half %4, half %9, half %5)

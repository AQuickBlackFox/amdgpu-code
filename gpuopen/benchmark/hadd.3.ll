...
define half @__rocm_hadd_cvt(half %a, half %b) {
...
define amdgpu_kernel void @DoHAdd(half* nocapture readonly %a, half* nocapture %b) local_unnamed_addr #5 {
...
; <label>:5:                                      ; preds = %5, %0
  ...
  %add = call half @__rocm_hadd_cvt(half %2, half %b0.015)
  %add.1 = call half @__rocm_hadd_cvt(half %2, half %add)
  %add.2 = call half @__rocm_hadd_cvt(half %2, half %add.1)
  %add.3 = call half @__rocm_hadd_cvt(half %2, half %add.2)
  %add.4 = call half @__rocm_hadd_cvt(half %2, half %add.3)
  %add.5 = call half @__rocm_hadd_cvt(half %2, half %add.4)
  %add.6 = call half @__rocm_hadd_cvt(half %2, half %add.5)
  %add.7 = call half @__rocm_hadd_cvt(half %2, half %add.6)
  %add.8 = call half @__rocm_hadd_cvt(half %2, half %add.7)
  %add.9 = call half @__rocm_hadd_cvt(half %2, half %add.8)
  %add.10 = call half @__rocm_hadd_cvt(half %2, half %add.9)
  %add.11 = call half @__rocm_hadd_cvt(half %2, half %add.10)
  %add.12 = call half @__rocm_hadd_cvt(half %2, half %add.11)
  %add.13 = call half @__rocm_hadd_cvt(half %2, half %add.12)
  %add.14 = call half @__rocm_hadd_cvt(half %2, half %add.13)
  %add.15 = call half @__rocm_hadd_cvt(half %2, half %add.14)
  %add.16 = call half @__rocm_hadd_cvt(half %2, half %add.15)
  %add.17 = call half @__rocm_hadd_cvt(half %2, half %add.16)
  %add.18 = call half @__rocm_hadd_cvt(half %2, half %add.17)
  %add.19 = call half @__rocm_hadd_cvt(half %2, half %add.18)
  %add.20 = call half @__rocm_hadd_cvt(half %2, half %add.19)
  %add.21 = call half @__rocm_hadd_cvt(half %2, half %add.20)
  %add.22 = call half @__rocm_hadd_cvt(half %2, half %add.21)
  %add.23 = call half @__rocm_hadd_cvt(half %2, half %add.22)
  %add.24 = call half @__rocm_hadd_cvt(half %2, half %add.23)
  %add.25 = call half @__rocm_hadd_cvt(half %2, half %add.24)
  %add.26 = call half @__rocm_hadd_cvt(half %2, half %add.25)
  %add.27 = call half @__rocm_hadd_cvt(half %2, half %add.26)
  %add.28 = call half @__rocm_hadd_cvt(half %2, half %add.27)
  %add.29 = call half @__rocm_hadd_cvt(half %2, half %add.28)
  %add.30 = call half @__rocm_hadd_cvt(half %2, half %add.29)
  %add.31 = call half @__rocm_hadd_cvt(half %2, half %add.30)
  %add.32 = call half @__rocm_hadd_cvt(half %2, half %add.31)
  %add.33 = call half @__rocm_hadd_cvt(half %2, half %add.32)
  %add.34 = call half @__rocm_hadd_cvt(half %2, half %add.33)
  %add.35 = call half @__rocm_hadd_cvt(half %2, half %add.34)
  %add.36 = call half @__rocm_hadd_cvt(half %2, half %add.35)
  %add.37 = call half @__rocm_hadd_cvt(half %2, half %add.36)
  %add.38 = call half @__rocm_hadd_cvt(half %2, half %add.37)
  %add.39 = call half @__rocm_hadd_cvt(half %2, half %add.38)
  %add.40 = call half @__rocm_hadd_cvt(half %2, half %add.39)
  %add.41 = call half @__rocm_hadd_cvt(half %2, half %add.40)
  %add.42 = call half @__rocm_hadd_cvt(half %2, half %add.41)
  %add.43 = call half @__rocm_hadd_cvt(half %2, half %add.42)
  %add.44 = call half @__rocm_hadd_cvt(half %2, half %add.43)
  %add.45 = call half @__rocm_hadd_cvt(half %2, half %add.44)
  %add.46 = call half @__rocm_hadd_cvt(half %2, half %add.45)
  %add.47 = call half @__rocm_hadd_cvt(half %2, half %add.46)
  %add.48 = call half @__rocm_hadd_cvt(half %2, half %add.47)
  %add.49 = call half @__rocm_hadd_cvt(half %2, half %add.48)
  %add.50 = call half @__rocm_hadd_cvt(half %2, half %add.49)
  %add.51 = call half @__rocm_hadd_cvt(half %2, half %add.50)
  %add.52 = call half @__rocm_hadd_cvt(half %2, half %add.51)
  %add.53 = call half @__rocm_hadd_cvt(half %2, half %add.52)
  %add.54 = call half @__rocm_hadd_cvt(half %2, half %add.53)
  %add.55 = call half @__rocm_hadd_cvt(half %2, half %add.54)
  %add.56 = call half @__rocm_hadd_cvt(half %2, half %add.55)
  %add.57 = call half @__rocm_hadd_cvt(half %2, half %add.56)
  %add.58 = call half @__rocm_hadd_cvt(half %2, half %add.57)
  %add.59 = call half @__rocm_hadd_cvt(half %2, half %add.58)
  %add.60 = call half @__rocm_hadd_cvt(half %2, half %add.59)
  %add.61 = call half @__rocm_hadd_cvt(half %2, half %add.60)
  %add.62 = call half @__rocm_hadd_cvt(half %2, half %add.61)
  %add.63 = call half @__rocm_hadd_cvt(half %2, half %add.62)

...
define float @__rocm_logf(float %a) {
  %1 = tail call float asm "v_log_f32 $0, $1","=v,v"(float %a)
  ret float %1
}

; Function Attrs: alwaysinline nounwind
define amdgpu_kernel void @DoLog(float* nocapture readonly %in1d, float* nocapture %outd) local_unnamed_addr #5 {
...
; <label>:5:                                      ; preds = %5, %0
  ...
  %add = tail call float @__rocm_logf(float %2)
  %add.1 = tail call float @__rocm_logf(float %add)
  %add.2 = tail call float @__rocm_logf(float %add.1)
  %add.3 = tail call float @__rocm_logf(float %add.2)
  %add.4 = tail call float @__rocm_logf(float %add.3)
  %add.5 = tail call float @__rocm_logf(float %add.4)
  %add.6 = tail call float @__rocm_logf(float %add.5)
  %add.7 = tail call float @__rocm_logf(float %add.6)
  %add.8 = tail call float @__rocm_logf(float %add.7)
  %add.9 = tail call float @__rocm_logf(float %add.8)
  %add.10 = tail call float @__rocm_logf(float %add.9)
  %add.11 = tail call float @__rocm_logf(float %add.10)
  %add.12 = tail call float @__rocm_logf(float %add.11)
  %add.13 = tail call float @__rocm_logf(float %add.12)
  %add.14 = tail call float @__rocm_logf(float %add.13)
  %add.15 = tail call float @__rocm_logf(float %add.14)
  %add.16 = tail call float @__rocm_logf(float %add.15)
  %add.17 = tail call float @__rocm_logf(float %add.16)
  %add.18 = tail call float @__rocm_logf(float %add.17)
  %add.19 = tail call float @__rocm_logf(float %add.18)
  %add.20 = tail call float @__rocm_logf(float %add.19)
  %add.21 = tail call float @__rocm_logf(float %add.20)
  %add.22 = tail call float @__rocm_logf(float %add.21)
  %add.23 = tail call float @__rocm_logf(float %add.22)
  %add.24 = tail call float @__rocm_logf(float %add.23)
  %add.25 = tail call float @__rocm_logf(float %add.24)
  %add.26 = tail call float @__rocm_logf(float %add.25)
  %add.27 = tail call float @__rocm_logf(float %add.26)
  %add.28 = tail call float @__rocm_logf(float %add.27)
  %add.29 = tail call float @__rocm_logf(float %add.28)
  %add.30 = tail call float @__rocm_logf(float %add.29)
  %add.31 = tail call float @__rocm_logf(float %add.30)
  %add.32 = tail call float @__rocm_logf(float %add.31)
  %add.33 = tail call float @__rocm_logf(float %add.32)
  %add.34 = tail call float @__rocm_logf(float %add.33)
  %add.35 = tail call float @__rocm_logf(float %add.34)
  %add.36 = tail call float @__rocm_logf(float %add.35)
  %add.37 = tail call float @__rocm_logf(float %add.36)
  %add.38 = tail call float @__rocm_logf(float %add.37)
  %add.39 = tail call float @__rocm_logf(float %add.38)
  %add.40 = tail call float @__rocm_logf(float %add.39)
  %add.41 = tail call float @__rocm_logf(float %add.40)
  %add.42 = tail call float @__rocm_logf(float %add.41)
  %add.43 = tail call float @__rocm_logf(float %add.42)
  %add.44 = tail call float @__rocm_logf(float %add.43)
  %add.45 = tail call float @__rocm_logf(float %add.44)
  %add.46 = tail call float @__rocm_logf(float %add.45)
  %add.47 = tail call float @__rocm_logf(float %add.46)
  %add.48 = tail call float @__rocm_logf(float %add.47)
  %add.49 = tail call float @__rocm_logf(float %add.48)
  %add.50 = tail call float @__rocm_logf(float %add.49)
  %add.51 = tail call float @__rocm_logf(float %add.50)
  %add.52 = tail call float @__rocm_logf(float %add.51)
  %add.53 = tail call float @__rocm_logf(float %add.52)
  %add.54 = tail call float @__rocm_logf(float %add.53)
  %add.55 = tail call float @__rocm_logf(float %add.54)
  %add.56 = tail call float @__rocm_logf(float %add.55)
  %add.57 = tail call float @__rocm_logf(float %add.56)
  %add.58 = tail call float @__rocm_logf(float %add.57)
  %add.59 = tail call float @__rocm_logf(float %add.58)
  %add.60 = tail call float @__rocm_logf(float %add.59)
  %add.61 = tail call float @__rocm_logf(float %add.60)
  %add.62 = tail call float @__rocm_logf(float %add.61)
  %add.63 = tail call float @__rocm_logf(float %add.62)

...
declare void @_Z7DoHADD216grid_launch_parmPiS0_S0_(%struct.grid_launch_parm* byval align 8, i32*, i32*, i32*) #4
...
; Function Attrs: alwaysinline uwtable
declare void @_Z9FuncHADD216grid_launch_parmPiS0_S0_(%struct.grid_launch_parm* byval align 8, i32*, i32*, i32*) #4
...
define i32 @main() #6 {
  ...
  store i32 0, i32* %1
  %6 = call noalias i8* @_Znam(i64 1024) #9
  %7 = bitcast i8* %6 to i32*
  store i32* %7, i32** %in1, align 8
  %8 = call noalias i8* @_Znam(i64 1024) #9
  %9 = bitcast i8* %8 to i32*
  store i32* %9, i32** %in2, align 8
  %10 = call noalias i8* @_Znam(i64 1024) #9
...
; <label>:48                                      ; preds = %31
  ...
  call void @__hcLaunchKernel__Z9FuncHADD216grid_launch_parmPiS0_S0_(%struct.grid_launch_parm* byval align 8 %2, i32* %53, i32* %54, i32* %55)
...
; <label>:92                                      ; preds = %57
  ...
  call void @__hcLaunchKernel__Z7DoHADD216grid_launch_parmPiS0_S0_(%struct.grid_launch_parm* byval align 8 %5, i32* %97, i32* %98, i32* %99)
...
declare void @__hcLaunchKernel__Z7DoHADD216grid_launch_parmPiS0_S0_(%struct.grid_launch_parm*, i32*, i32*, i32*)

declare void @__hcLaunchKernel__Z9FuncHADD216grid_launch_parmPiS0_S0_(%struct.grid_launch_parm*, i32*, i32*, i32*)
...
attributes #4 = { alwaysinline uwtable "hc_grid_launch" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
